        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-8 famille-section">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        @foreach($produitsGroupe as $produit)
                            <a href="{{ route('cuisson-refroidissement.create', $produit) }}"
                               ...
                               class="produit-card block p-6 bg-white border-2 border-gray-200 rounded-xl hover:border-orange-500 hover:shadow-lg transition-all duration-200">
                                <div class="text-center">
                                    ...
                                    <h5 class="font-bold text-gray-900 mb-2">{{ $produit->nom }}</h5>
            ...
            @if($produits->isEmpty())
                <div class="text-center py-12 bg-gray-50 rounded-lg">
                    ...
                    <a href="{{ route('produits.create') }}" class="mt-4 inline-block text-orange-600 hover:text-orange-700">
                        Ajouter un produit
                    </a>
                </div>
            @endif
