...
<head>
    ...
    <title>Étiquettes - {{ $lot->produit->nom }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
@for($i = 1; $i <= $nombre; $i++)
    <div class="etiquette-page">
        <div class="etiquette">
            <div class="jour-box">
                <div class="jour-lettre">{{ $lettreJour }}</div>
                <div class="jour-nom">{{ $nomJour }}</div>
            </div>

            <div class="content">
                <div class="produit-nom">{{ $lot->produit->nom }}</div>

                <div class="info-grid">
                    <div class="info-box">
                        <div class="info-label">DATE DLC</div>
                        <div class="info-value">{{ $lot->dlc->format('d/m/Y') }}</div>
                    </div>
                    <div class="info-box">
                        <div class="info-label">JOURS DLC</div>
                        <div class="info-value">{{ $joursRestants }} J</div>
                    </div>
                </div>

                <div class="dlc-box">
                    <div class="dlc-label">PRODUIT LE</div>
                    <div class="dlc-value">{{ $lot->date_production->format('d/m/Y H:i') }}</div>
                </div>
            </div>
        </div>
    </div>
