...
<?php foreach($attributes->onlyProps(['name' => 'photo', 'label' => 'Photo', 'required' => false, 'autostart' => false]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['name' => 'photo', 'label' => 'Photo', 'required' => false, 'autostart' => false]); ?>
<?php foreach (array_filter((['name' => 'photo', 'label' => 'Photo', 'required' => false, 'autostart' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<div x-data="cameraCapture({ autostart: <?php echo e($autostart ? 'true' : 'false'); ?> })" class="space-y-4">
    ...
    <div x-show="capturedImage" class="mb-4">
        ...
        <input type="hidden" :name="'<?php echo e($name); ?>'" :value="capturedImage">
...
<?php /**PATH C:\laragon\www\haccp.grolleau\haccp-app\resources\views\components\camera-capture.blade.php ENDPATH**/ ?>