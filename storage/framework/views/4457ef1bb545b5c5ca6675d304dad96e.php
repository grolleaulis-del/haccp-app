...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Créer un nouveau produit')); ?>
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center">
                                    <input type="radio" name="mode_tracabilite" value="etiquette_photo"
                                           <?php echo e(old('mode_tracabilite', 'etiquette_photo') === 'etiquette_photo' ? 'checked' : ''); ?>
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="mode_tracabilite" value="code_interne"
                                           <?php echo e(old('mode_tracabilite') === 'code_interne' ? 'checked' : ''); ?>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="dlc_cuisson_defaut_jours" id="dlc_cuisson_defaut_jours" min="1"
                                       value="<?php echo e(old('dlc_cuisson_defaut_jours')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="dlc_congelation_defaut_jours" id="dlc_congelation_defaut_jours" min="1"
                                       value="<?php echo e(old('dlc_congelation_defaut_jours')); ?>"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\haccp.grolleau\haccp-app\resources\views\produits\create.blade.php ENDPATH**/ ?>