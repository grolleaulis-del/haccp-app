...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Éditer relevé température')); ?>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('temperatures.update', $releve)); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                <?php $__currentLoopData = $equipements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($eq->id); ?>" <?php echo e($releve->equipement_temperature_id == $eq->id ? 'selected' : ''); ?>>
                                        <?php echo e($eq->nom); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="temperature" id="temperature" step="0.1" value="<?php echo e($releve->temperature); ?>" required class="w-full rounded-md border-gray-300 <?php $__errorArgs = ['temperature'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div>
                            ...
                            <div class="flex gap-6">
                                <label class="flex items-center">
                                    <input type="radio" name="conforme" value="1" <?php echo e($releve->conforme ? 'checked' : ''); ?> class="rounded border-gray-300">
                                    <span class="ml-2 text-sm text-gray-700">✓ Oui (conforme)</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="conforme" value="0" <?php echo e(!$releve->conforme ? 'checked' : ''); ?> class="rounded border-gray-300">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="action_corrective" id="action_corrective" rows="3" class="w-full rounded-md border-gray-300"><?php echo e($releve->action_corrective); ?></textarea>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\haccp.grolleau\haccp-app\resources\views\temperatures\edit.blade.php ENDPATH**/ ?>