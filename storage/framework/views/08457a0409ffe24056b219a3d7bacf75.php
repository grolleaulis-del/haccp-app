...
<div class="w-full px-2 py-4">
    ...
    <div class="bg-white rounded-lg shadow-md p-4">
        <form action="<?php echo e(route('nettoyage.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-6">
                ...
                <select name="tache_nettoyage_id" required class="w-full border-2 border-gray-300 rounded px-4 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <?php $__currentLoopData = $taches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tache): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tache->id); ?>" <?php echo e(old('tache_nettoyage_id') == $tache->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <input type="datetime-local" name="done_at" required
                    value="<?php echo e(old('done_at', now()->format('Y-m-d\TH:i'))); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <textarea name="commentaire" rows="4" class="w-full border-2 border-gray-300 rounded px-4 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('commentaire')); ?></textarea>
