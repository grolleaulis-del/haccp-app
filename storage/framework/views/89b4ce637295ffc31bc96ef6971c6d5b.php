                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="printer_name" id="printer_name"
                                           value="<?php echo e(old('printer_name', $printer_name)); ?>"
                                ...
                                <div>
                                    ...
                                    <select name="printer_type" id="printer_type"
                                            class="w-full rounded-md border-gray-300">
                                        <option value="zebra" <?php echo e($printer_type === 'zebra' ? 'selected' : ''); ?>>
                                            Zebra (ZPL)
                                        </option>
                                        <option value="brother" <?php echo e($printer_type === 'brother' ? 'selected' : ''); ?>>
                                            Brother (P-Touch)
                                        </option>
                                        <option value="dymo" <?php echo e($printer_type === 'dymo' ? 'selected' : ''); ?>>
                                            Dymo
                                        </option>
                                        <option value="generic" <?php echo e($printer_type === 'generic' ? 'selected' : ''); ?>>
                                            Générique (PDF)
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="number" name="label_width" id="label_width"
                                               value="<?php echo e(old('label_width', $label_width)); ?>"
                                               class="w-full rounded-md border-gray-300"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="label_height" id="label_height"
                                               value="<?php echo e(old('label_height', $label_height)); ?>"
                                               class="w-full rounded-md border-gray-300"
                                               min="10" max="500" step="1">
                                    </div>
                                </div>
                        ...
                        <div class="mb-8 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <input type="number" name="inactivity_timeout" id="inactivity_timeout"
                                       value="<?php echo e(old('inactivity_timeout', $inactivity_timeout)); ?>"
                                       class="w-full rounded-md border-gray-300"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\haccp.grolleau\haccp-app\resources\views\settings\index.blade.php ENDPATH**/ ?>